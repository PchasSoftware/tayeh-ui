...
loadingDirective.install = (Vue, opts) => {
        ...
        () => {
          ...
          const target =
            binding.modifiers.fullscreen || binding.modifiers.body
              ? document.body
              : el;
          removeClass(target, "ty-loading-parent--relative");
          removeClass(target, "ty-loading-parent--hidden");
  ...
  const insertDom = (parent, el, binding) => {
    if (
      ...
      if (
        ...
        addClass(parent, "ty-loading-parent--relative");
      }
      if (binding.modifiers.fullscreen && binding.modifiers.lock) {
        addClass(parent, "ty-loading-parent--hidden");
      }
      el.domVisible = true;
  ...
  Vue.directive("loading", {
    bind: function(el, binding) {
      ...
      // let sp = document.querySelector(".v-loading-spinner");
    ...
    update: function(el, binding) {
      el.instance.setText(
        el.getAttribute("element-loading-text") || options.text
      );
